        ...
        <header class="container">
            <div class="row">
                <div class="col-sm-3">
                    <ul >
                        <li class="Bio">
                            <a href="Bio_Tech/Semester/sem.php">Bio.Tech</a>
                        </li>
                    </ul>
                </div>
                <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                <ul>
                 <li class="sem"><a href="../../../Upload/Question/Branch/1st_Sem/browse.php">1<sup>st</sup> Sem</a></li>
                 </ul>
            </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <ul>
                 ...
                 <li class="sem"><a href="../../../Upload/Question/Branch/1st_Sem/browse.php">2<sup>nd</sup> Sem</a></li>
